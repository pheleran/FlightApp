...
const FlightTable: FC<Props> = ({ flights, isFlightOneWay, airports }) => {
    ...
    return (
        <div className="bg-white w-full p-10 mt-10 rounded-lg border">
            ...
            {isFlightOneWay == true ? <h1 className="text-xl font-bold mb-5"> Uygun Uçuşlar</h1> : <h1 className="text-xl font-bold mb-5" > Gidiş Uçuşları</h1>}
            <table className="min-w-full text-left text-md font-light p-10 mb-10">
                ...
                <tbody>
                    {flightsSorted != undefined ? flightsSorted.map((flight: Flight) => <tr className=" border-b dark:border-neutral-500 ">
